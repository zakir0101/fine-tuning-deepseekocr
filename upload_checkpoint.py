...
os.environ["CUDA_VISIBLE_DEVICES"] = ""  # Hide GPU from detection
os.environ["UNSLOTH_DEVICE_TYPE"] = "cpu"  # Force CPU mode
...
model, tokenizer = FastVisionModel.from_pretrained(
    model_name="outputs/checkpoint-1200",  # YOUR MODEL YOU USED FOR TRAINING
